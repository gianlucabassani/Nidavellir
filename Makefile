...
.PHONY: help venv install-dev check-python test test-unit test-integration \
	...
	verify-nv02-live verify-nv03-live verify-nv04-live verify-nv05-live verify-nv06-live verify-nv07-live build-poc-runner up down dev dev-down dev-logs logs clean
...
verify-nv06-live: ## Isolated Docker independent-validation acceptance
	python3 scripts/verify-nv06-live.py

verify-nv07-live: ## Isolated Docker paired-evaluation acceptance
	python3 scripts/verify-nv07-live.py
