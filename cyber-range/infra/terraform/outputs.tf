...
output "log_vm_name" {
  ...
  value       = openstack_compute_instance_v2.nidavellir_log.name
}
...
output "log_vm_ssh_command" {
  ...
  value       = "ssh -i nidavellir_ssh_key.pem ubuntu@${openstack_networking_floatingip_v2.log_fip.address}"
}
...
output "attack_vm_name" {
  ...
  value       = openstack_compute_instance_v2.nidavellir_attack.name
}
...
output "attack_vm_ssh_command" {
  ...
  value       = "ssh -i nidavellir_ssh_key.pem kali@${openstack_networking_floatingip_v2.attack_fip.address}"
}
...
output "victim_vm_name" {
  ...
  value       = openstack_compute_instance_v2.nidavellir_victim.name
}
...
output "private_network_name" {
  ...
  value       = openstack_networking_network_v2.networknidavellir.name
}

output "router_name" {
  description = "Nome del router"
  value       = openstack_networking_router_v2.nidavellir_router.name
}
...
output "setup_instructions" {
  ...
  ├─ Nome rete:        ${openstack_networking_network_v2.networknidavellir.name}
  └─ Router:           ${openstack_networking_router_v2.nidavellir_router.name}
  
    VM LOG (Monitor & IDS)
  ├─ Nome:             ${openstack_compute_instance_v2.nidavellir_log.name}
  ...
  └─ SSH:              ssh -i nidavellir_ssh_key.pem ubuntu@${openstack_networking_floatingip_v2.log_fip.address}
  
    VM ATTACK (Kali Linux)
  ├─ Nome:             ${openstack_compute_instance_v2.nidavellir_attack.name}
  ...
  └─ SSH:              ssh -i nidavellir_ssh_key.pem kali@${openstack_networking_floatingip_v2.attack_fip.address}
...
output "quick_commands" {
  ...
  value = {
    ssh_log    = "ssh -i nidavellir_ssh_key.pem ubuntu@${openstack_networking_floatingip_v2.log_fip.address}"
    ssh_attack = "ssh -i nidavellir_ssh_key.pem kali@${openstack_networking_floatingip_v2.attack_fip.address}"
